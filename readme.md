...
From all the files provided, the most important ones to focus on for this seminar are the Fexigo library $\texttt{fexigo.py}$ and the $\texttt{fexigo_mnist_demo.ipynb}$ notebook.
